...
abstract class $SubjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int count, int id});
}
...
class _$_Subject with DiagnosticableTreeMixin implements _Subject {
  const _$_Subject({required this.name, required this.count, required this.id});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Subject(name: $name, count: $count, id: $id)';
  }
...
abstract class _Subject implements Subject {
  const factory _Subject(
      ...
      required final int id}) = _$_Subject;
